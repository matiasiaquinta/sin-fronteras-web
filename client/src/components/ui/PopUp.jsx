...
import PlanSelector from '../Selector/selector';
...
export function Popup({ onClose, alumno }) {
  ...
  const handleSubmit = async e => {
    ...
    const abono = editedAlumno.abonoEfectivo || editedAlumno.abonoTransferencia;
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    {deportes.map(deporte => (
                      <div key={deporte.value}>
                        <input
                          ...
                          checked={editedAlumno.deporte.includes(deporte.value)}
              ...
              <div className="mb-2">
                ...
                >
                  ...
                  <PlanSelector
                    selectedPlan={editedAlumno.plan}
              ...
              <div className="mb-2">
                ...
                {isCustom && (
                  <input
                    type="text"
                    value={editedAlumno ? editedAlumno.fechaPago || '' : ''}
                ...
                {errors.fechaPago && (
                  <p className="text-red-500">{errors.fechaPago.message}</p>
                )}
              </div>
              ...
              <div className="mb-2 mt-2">
                <div className="mb-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <Input
                      ...
                      onChange={handleChangePrecioEfectivo}
                    />
                  </div>
                </div>
                ...
                <div className="mb-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <Input
                      type="number"
                      value={editedAlumno.precioTransferencia}
                      className="w-72 bg-white text-black px-4 py-2 my-2 rounded-md"
                      onChange={handleChangePrecioTransferencia}
                    />
                  </div>
                </div>
              </div>
